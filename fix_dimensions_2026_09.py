...
# Lot 3 : slots M.2 (clé M, pour SSD) et ports SATA des cartes mères, fiches fabricant
# (msi.com, asus.com / rog.asus.com, gigabyte.com, asrock.com / pg.asrock.com).
CARTES_MERES = {
    2070: ("MSI B850 Gaming Plus WIFI", 2, 4),
    2071: ("MSI MPG B550 Gaming Plus", 2, 6),
    2072: ("GIGABYTE B650 Eagle AX", 3, 4),
    2073: ("MSI X870E Gaming Plus WiF", 3, 4),
    2074: ("MSI B760 Gaming Plus WiFi", 2, 4),
    2075: ("MSI Pro B760-P WiFi DDR4", 2, 4),
    2076: ("MSI B550M Pro-VDH WiFi", 2, 4),
    2077: ("MSI B550 Gaming WiFi", 2, 6),
    2078: ("MSI B850M Gaming Plus WIF", 2, 4),
    2079: ("MSI MPG B850 Edge TI WiFi", 4, 4),
    2080: ("MSI Pro H610M-E DDR4", 1, 4),
    2081: ("MSI B850 Gaming Plus WiFi", 3, 4),
    2082: ("MSI B760 Gaming Plus WiFi", 2, 4),
    2083: ("MSI Z790 Gaming Plus WiFi", 4, 6),
    2084: ("MSI B550 Gaming ATX", 1, 6),
    2085: ("MSI B550-A Pro AM4", 2, 6),
    2086: ("MSI MAG B850 Tomahawk Max", 4, 4),
    2087: ("MSI MAG Z790 Tomahawk WiF", 4, 7),
    2090: ("MSI MAG B850M Mortar WiFi", 3, 4),
    2091: ("MSI Pro B650-A WiFi", 3, 6),
    2092: ("MSI MPG X870E Carbon WiFi", 4, 4),
    2093: ("MSI MPG Z890 Edge TI WiFi", 5, 4),
    2094: ("MSI B850M Gaming Plus WiF", 2, 4),
    2095: ("MSI B760M Gaming Plus WiF", 2, 4),
    2097: ("ASUS TUF Gaming B850-PLUS", 3, 4),
    2098: ("GIGABYTE B550M AORUS ELIT", 2, 4),
    2099: ("GIGABYTE B850 Gaming WIFI", 3, 4),
    2100: ("GIGABYTE B550 Gaming X V2", 2, 4),
    2101: ("GIGABYTE A520M K V2", 1, 4),
    2102: ("ASUS Prime B550M-A WIFI I", 2, 4),
    2103: ("ASUS TUF Gaming B550-PLUS", 2, 6),
    2104: ("ASUS ROG Strix B550-A Gam", 2, 6),
    2105: ("GIGABYTE B850 AORUS Elite", 3, 4),
    2106: ("GIGABYTE B550M Gaming X W", 2, 4),
    2107: ("MSI A520M-A PRO AM4", 1, 4),
    2108: ("GIGABYTE B550M K", 2, 4),
    2109: ("MSI B550M Pro-VDH Micro-A", 2, 4),
    2110: ("GIGABYTE B650 Eagle", 3, 4),
    2111: ("GIGABYTE B650 Gaming X AX", 3, 4),
    2114: ("GIGABYTE B760 Gaming X DD", 3, 4),
    2115: ("GIGABYTE B550 Eagle WIFI6", 2, 4),
    2116: ("ASUS TUF Gaming B650-E Wi", 3, 4),
    2117: ("GIGABYTE B650 AORUS ELITE", 3, 4),
    2118: ("ASUS Prime Z890-P WiFi", 4, 4),
    2119: ("GIGABYTE B850 AORUS Steal", 4, 2),
    2120: ("GIGABYTE B850 Eagle WIFI6", 3, 4),
    2121: ("GIGABYTE B850 Gaming X WI", 3, 4),
    2122: ("GIGABYTE B850 Eagle Ice", 3, 4),
    2123: ("GIGABYTE X870 A Elite WIF", 4, 4),
    2124: ("GIGABYTE B760M Gaming Plu", 2, 4),
    2125: ("GIGABYTE B650M Gaming WIF", 1, 4),
    2126: ("GIGABYTE B550M DS3H AC R2", 2, 4),
    2127: ("GIGABYTE B550M AORUS Elit", 2, 4),
    2128: ("GIGABYTE B850M AORUS Elit", 2, 4),
    2129: ("ASUS ROG Strix B850-A Gam", 4, 2),
    2130: ("ASRock B550M-HDV Micro AT", 1, 4),
    2131: ("ASRock B650M-HDV/M.2 DDR5", 2, 4),
    2132: ("ASRock B850 Rock WiFi 7", 2, 4),
    2133: ("ASRock B650M Pro RS AM5", 3, 4),
    2134: ("ASRock A520M-HVS", 1, 4),
    2136: ("ASRock B550 Phantom Gamin", 2, 6),
    2137: ("ASRock B650 Steel Legend ", 3, 4),
    2138: ("ASRock B850 Riptide WiFi", 4, 4),
    2139: ("ASRock B850 Pro RS DDR5", 4, 4),
    2140: ("ASRock B850M-X WiFi R2.0", 2, 4),
    2141: ("ASRock B850M Pro RS WiFi", 3, 4),
    2142: ("ASRock B860 Pro RS DDR5", 3, 4),
    2143: ("ASRock B850M Challenger W", 2, 4),
    2144: ("ASRock B850 Pro RS WiFi", 4, 4),
    2146: ("ASRock B550M-ITX/ac Mini ", 1, 4),
    2147: ("ASRock B850M-X R2.0", 2, 4),
    2148: ("ASRock A520M-HDV Socket A", 1, 4),
    2149: ("ASRock A520M-ITX/ac", 1, 4),
    2150: ("ASRock B850I Lightning Wi", 2, 2),
    2156: ("ASUS ROG Strix B550-F Gam", 2, 6),
    2157: ("ASUS Prime B760M-A D4", 2, 4),
    2158: ("ASUS TUF Gaming B550-PLUS", 2, 6),
    2159: ("GIGABYTE H610M S2H V3 DDR", 1, 4),
    2160: ("MSI Pro B760M-P DDR4 LGA ", 2, 4),
    2161: ("ASUS Prime Z890M-PLUS WiF", 3, 6),
    2162: ("ASUS ROG Strix X870E-E Ga", 5, 4),
    2163: ("ASUS ROG Strix X870-F Gam", 4, 2),
    2165: ("ASUS ROG Strix X870-A Gam", 4, 2),
    2166: ("ASUS ROG Crosshair X870E ", 5, 4),
    2167: ("ASUS TUF Gaming B650-Plus", 3, 4),
    2168: ("ASUS ROG Strix B850-F Gam", 4, 2),
    2169: ("ASUS ROG Strix Z890-F Gam", 5, 4),
    2170: ("ASUS ROG Strix B550-F Gam", 2, 6),
    2171: ("ASUS ROG Strix B650E-E Ga", 4, 4),
    2172: ("ASUS TUF Gaming X870-PLUS", 4, 2),
    2173: ("ASUS TUF Gaming B760-PLUS", 3, 4),
    2175: ("ASUS ROG Maximus Z890 Her", 6, 4),
    2176: ("ASUS ROG Strix B850-E Gam", 5, 4),
    2177: ("ASUS TUF Gaming X870E-PLU", 4, 4),
    2178: ("ASUS Prime B650M-A WiFi I", 2, 4),
    2179: ("ASUS ROG Strix B850-I Gam", 2, 2),
    2180: ("ASUS TUF Gaming B550M-Plu", 2, 4),
    2181: ("MSI B650M Gaming Plus WiF", 2, 4),
    2182: ("ASUS TUF Gaming B850-E Wi", 3, 4),
    2183: ("ASUS TUF B450-PLUS GAMING", 2, 6),
    2184: ("GIGABYTE B650M Gaming Plu", 2, 4),
    2185: ("ASUS TUF Gaming B550M-PLU", 2, 4),
    2187: ("MSI X870 Gaming Plus WiFi", 3, 4),
    2188: ("ASUS TUF Gaming A520M-Plu", 1, 4),
    2189: ("MSI B860 Gaming Plus WiFi", 3, 4),
    2191: ("ASUS TUF Gaming A620M-Plu", 2, 4),
    2192: ("MSI B840M Gaming Plus WIF", 2, 4),
    2193: ("ASUS TUF Gaming Z890-PLUS", 4, 4),
    2194: ("ASUS TUF Gaming B850-PLUS", 3, 4),
    2820: ("ASUS ROG Strix B760-F Gam", 3, 4),
    2821: ("ASUS TUF Gaming B850M-E W", 3, 4),
    2822: ("ASUS ROG Strix B850-A Gam", 4, 2),
    2823: ("ASUS TUF Gaming B760-Plus", 3, 4),
    2825: ("ASUS TUF Gaming B650M-Plu", 2, 4),
    2826: ("ASUS TUF Gaming B650E-E W", 3, 4),
    2833: ("ASUS ROG Strix Z890-H Gam", 4, 4),
    2834: ("ASUS TUF Gaming B760-Plus", 3, 4),
